...
function App() {
  ...
  const [message, setMessage] = useState('Take-home budget saved locally on this device.')
  ...
  function handleAddIncome(event: FormEvent<HTMLFormElement>) {
    ...
    if (!amountCents) {
      setMessage('Enter a take-home amount before saving.')
      return
    }
    ...
    commitData(
      ...
      'Take-home pay added. Recorded total updated.',
    )
  ...
  function handleSaveIncomeEdit(income: IncomeEntry) {
    ...
    if (!draft || !amountCents) {
      setMessage('Use a valid amount before updating this take-home entry.')
      return
    }
      ...
      >
        ...
        <div className="overview-headline">
          ...
          <label className="field field--compact">
            ...
            <input
              aria-label="Expected monthly take-home"
              inputMode="decimal"
              type="text"
        ...
        >
          <form className="form-grid" onSubmit={handleAddIncome}>
            ...
            <label className="field field--wide">
              ...
              <input
                aria-label="Take-home note"
                type="text"
                placeholder="Paycheck deposit, cash received"
                ...
                return (
                  ...
                  >
                    <div className="list-row__main">
                      <div>
                        <strong>{income.note || 'Take-home income entry'}</strong>
                        <div className="list-row__meta">
                          <span>{income.date}</span>
                          <span>Recorded take-home pay</span>
                        </div>
                      </div>
                    ...
                    {isEditing ? (
                      <div className="edit-grid">
                        <label className="field">
                          <span>Amount</span>
                          <input
                            aria-label={`Take-home amount ${income.id}`}
                            inputMode="decimal"
                            type="text"
                        ...
                        <label className="field">
                          <span>Date</span>
                          <input
                            aria-label={`Take-home date ${income.id}`}
                            type="date"
                        ...
                        <label className="field field--wide">
                          <span>Note</span>
                          <input
                            aria-label={`Take-home note ${income.id}`}
                            type="text"
